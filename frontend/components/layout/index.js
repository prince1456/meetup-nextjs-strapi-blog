...
export default function Layout({ children }) {
  return (
    <div className="container mx-auto">
      <div className="prose max-w-none sm:prose-lg md:prose-base lg:prose-lg xl:prose-xl 2xl:prose-2xl relative overflow-hidden">
      

        <div className="relative not-prose pt-6 pb-16 sm:pb-24">
          <Popover>
